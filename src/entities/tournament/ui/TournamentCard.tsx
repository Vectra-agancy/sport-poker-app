...
export function TournamentCard({ tournament, onClick }: TournamentCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full text-left rounded-2xl bg-gradient-to-br from-burgundy-700 to-burgundy-800 border border-amber-900/20 p-4 active:scale-[0.98] transition shadow-lg"
    >
